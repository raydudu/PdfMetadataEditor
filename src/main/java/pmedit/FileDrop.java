    ...
    {   
        ...
        {   // Make a drop listener
            ...
            {   public void dragEnter( java.awt.dnd.DropTargetDragEvent evt )
            	...
            	public Point getEventPoint(java.awt.dnd.DropTargetDragEvent evt) {
                	return SwingUtilities.convertPoint(evt.getDropTargetContext().getComponent(), evt.getLocation(), c);
            	}
            	public Point getEventPoint(java.awt.dnd.DropTargetDropEvent evt) {
                	return SwingUtilities.convertPoint(evt.getDropTargetContext().getComponent(), evt.getLocation(), c);
            	}
